...
using WorkPlaceConnector.Authentication;
using WorkPlaceConnector.Console;
using WorkPlaceConnector.Data;
using WorkPlaceConnector.Graph;
...
namespace WorkPlaceConnector
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            try
            {
                Output.WriteLine("WorkPlace Search Connector\n");
                ...
                do
                {
                    ...
                    switch (userChoice)
                    {
                        ...
                        case MenuChoice.PushItems:
                            UploadItemsFromCsvAsync("Workplace.csv").Wait();
                            break;
        ...
        private static async Task RegisterSchemaAsync()
        {
            ...
            try
            {
                ...
                var schema = new Schema
                {
                    ...
                    {
                        new Property { Name = "PostId", Type = Property.IntProperty, IsQueryable = true, IsSearchable = false, IsRetrievable = true },
                        new Property { Name = "URL", Type = Property.StringProperty, IsQueryable = true, IsSearchable = false, IsRetrievable = true },
                        new Property { Name = "PostedBy", Type = Property.StringProperty, IsQueryable = true, IsSearchable = true, IsRetrievable = true },
                        new Property { Name = "description", Type = Property.StringProperty, IsQueryable = true, IsSearchable = true, IsRetrievable = true },
                        new Property { Name = "PostedOn", Type = Property.DateTimeProperty, IsQueryable = true, IsSearchable = false, IsRetrievable = true },
                    }
                };
        ...
        private static async Task UploadItemsFromCsvAsync(string filePath)
        {
            ...
            foreach(var part in records)
            {
                ...
                try
                {
                    Output.Write(Output.Info, $"Uploading part number {part.PostId}...");
                ...
                catch (ServiceException serviceException)
                {
                    ...
                    Output.WriteLine(Output.Error, $"{serviceException.StatusCode} error adding or updating part {part.PostId}");
                    Output.WriteLine(Output.Error, serviceException.Message);
                }
            }
        }
